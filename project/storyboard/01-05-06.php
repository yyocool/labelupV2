...
include __DIR__ . '/_fragments/zone-data-01-05-06.php';
...
if (!empty($sbRenderMode) && $sbRenderMode === 'wireframe') {
    ...
    include __DIR__ . '/_fragments/01-05-06-hifi-styles.php';
    echo '</style>';
    include __DIR__ . '/_fragments/01-05-06-hifi-wireframe-body.php';
...
$sbWfBodyFragment = __DIR__ . '/_fragments/01-05-06-hifi-wireframe-body.php';
$pageTitle = isset($menu['title']) ? $menu['title'] : 'Label-UP 도움말';
$menuCode = isset($menu['menu_code']) ? $menu['menu_code'] : '01-05-06';
?>
<style>
<?php include __DIR__ . '/_fragments/wf-shared-styles.php'; ?>
<?php include __DIR__ . '/_fragments/01-05-06-hifi-styles.php'; ?>
</style>
