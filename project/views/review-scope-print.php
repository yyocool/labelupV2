...
$filename = '검수_' . preg_replace('/[^\w가-힣\-]+/u', '_', $scopeLabel) . '_' . date('Ymd');
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .ds-print-table .col-d1 { width: 14%; font-weight: 700; color: var(--d1); }
        .ds-print-table .col-d2 { width: 14%; font-weight: 600; color: var(--d2); }
        .ds-print-table .col-d3 { width: 16%; }
        .ds-print-table .col-url { width: 14%; color: #1d4ed8; word-break: break-all; font-size: 10px; }
        .ds-print-table .col-prio { width: 48px; text-align: center; white-space: nowrap; }
        .ds-print-table .col-status { width: 72px; text-align: center; white-space: nowrap; }
        .ds-print-table .col-review { width: 72px; text-align: center; white-space: nowrap; }
        .ds-print-table .col-rcomment { width: auto; color: #475569; }
        ...
        .ds-print-table tr.is-out .col-rcomment { text-decoration: none; }
        .ds-print-table tr.is-review-in_review td { background: #dbeafe !important; }
        .ds-print-table tr.is-review-done td { background: #dcfce7 !important; }
        .ds-print-table tr.is-review-need_fix td { background: #fee2e2 !important; }
        .ds-print-table tr.is-dev-planned td.col-status { background: #e2e8f0 !important; }
        .ds-print-table tr.is-dev-in_progress td.col-status { background: #93c5fd !important; }
        .ds-print-table tr.is-dev-done td.col-status { background: #86efac !important; }
        .ds-print-table tr.is-dev-deferred td.col-status { background: #fcd34d !important; }
        .ds-print-table tr.is-dev-out td.col-status { background: #cbd5e1 !important; }
        ...
        .ds-print-badge--planned { background: #e2e8f0; color: #475569; }
        ...
        .ds-print-badge--review-in_review { background: #bfdbfe; color: #1d4ed8; }
        .ds-print-badge--review-done { background: #bbf7d0; color: #15803d; }
        .ds-print-badge--review-need_fix { background: #fecaca; color: #b91c1c; }
...
<body class="ds-print-body">
    <div class="ds-print-bar">
        <strong>검수 PDF</strong>
        <span class="meta"><?= e($projectName) ?> · <?= e($scopeLabel) ?> · <?= (int) $totalRows ?>행</span>
        <a class="ds-print-btn ds-print-btn--ghost" href="<?= url('review-scope.php?print=1&noprint=1') ?>">미리보기</a>
        <a class="ds-print-btn ds-print-btn--ghost" href="<?= url('review-scope.php') ?>">← 돌아가기</a>
        <button type="button" class="ds-print-btn" id="rsPdfPrint">PDF로 저장</button>
    </div>

    <div class="ds-print-sheet">
        <header class="ds-print-head">
            <p class="ds-print-eyebrow">검수 · Review Scope</p>
            ...
            <table class="ds-print-table">
                <thead>
                    <tr>
                        ...
                        <th class="col-url">페이지URL</th>
                        <th class="col-prio">우선</th>
                        <th class="col-status">개발자확인</th>
                        <th class="col-review">검수상태</th>
                        <th class="col-rcomment">검수코멘트</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php
                        ...
                        $reviewStatusesMap = isset($reviewStatuses) ? $reviewStatuses : DevScopeService::getReviewStatuses();
                        $reviewStatus = DevScopeService::normalizeReviewStatus(
                            isset($it['review_status'])
                                ? $it['review_status']
                                : (empty($it['review_confirmed']) ? 'in_review' : 'done')
                        );
                        $reviewLabel = isset($reviewStatusesMap[$reviewStatus]) ? $reviewStatusesMap[$reviewStatus] : $reviewStatus;
                        ...
                        $trClass = 'is-d' . $d . ' is-dev-' . $st;
                        if ($st === 'done') $trClass .= ' is-done';
                        if ($st === 'out') $trClass .= ' is-out';
                        $trClass .= ' is-review-' . $reviewStatus;
                    ...
                    <tr class="<?= e($trClass) ?>">
                        ...
                        <td class="col-review"><span class="ds-print-badge ds-print-badge--review-<?= e($reviewStatus) ?>"><?= e($reviewLabel) ?></span></td>
                        <td class="col-rcomment"><?= e($reviewComment) ?></td>
                    </tr>
                    <?php
                        $prevD1Id = $d1Id;
                        $prevD2Id = $d2Id;
    ...
    (function () {
        ...
        var btn = document.getElementById('rsPdfPrint');
